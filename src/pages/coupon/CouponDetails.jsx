                ...
                <Box sx={{ mb: 3 }}>
                  ...
                  <Box sx={{ mt: 2, display: "flex", gap: 4 }}>
                    ...
                    <Typography>
                      ...
                      {coupon.totalComments || 0}
                    </Typography>
                    <Typography>
                      <strong>Amount Spent:</strong> {coupon.amountSpent || 0}
                    </Typography>
                  </Box>
                  ...
                  {coupon.socialMediaLink && (
                    <>
                      ...
                      {Array.isArray(coupon.image) &&
                        coupon.image.length > 0 && (
                          <Box
                            sx={{
                              mt: 2,
                              position: "relative",
