            ...
            <Container maxWidth="lg" sx={{ py: 4 }}>
                ...
                <Grid container spacing={3}>
                    ...
                    <Grid item xs={12} md={6}>
                        <Card sx={{ height: '100%', borderRadius: 3, boxShadow: theme.shadows[3] }}>
                            <CardContent sx={{ p: 3 }}>
                                <Typography variant="h6" fontWeight={600} sx={{ mb: 2 }}>Social Media</Typography>
                                <Divider sx={{ mb: 3 }} />
                    ...
                    {user.owen && (
                        <Grid item xs={12}>
                            <Card sx={{ borderRadius: 3, boxShadow: theme.shadows[3] }}>
                                <CardContent sx={{ p: 3 }}>
                                    <Typography variant="h6" fontWeight={600} sx={{ mb: 2 }}>Shop Information</Typography>
                                    <Divider sx={{ mb: 3 }} />
                                    <Grid container spacing={3}>
                                        <Grid item xs={12} md={6}>
                                            <Stack spacing={2}>
                                                <Box>
                                                    ...
                                                    <Typography variant="body1">{user.owen.name}</Typography>
                                                </Box>
                                                <Box>
                                                    <Typography variant="subtitle2" color="text.secondary">Email</Typography>
                                                    <Typography variant="body1">{user.owen.email}</Typography>
                                                </Box>
                                                <Box>
                                                    <Typography variant="subtitle2" color="text.secondary">Address</Typography>
                                                    <Typography variant="body1">{user.owen.address}</Typography>
                                                </Box>
                                            </Stack>
                                        </Grid>
                                        <Grid item xs={12} md={6}>
                                            <Stack spacing={2}>
                                                <Box>
                                                    ...
                                                    <Typography variant="body1">{user.owen.description}</Typography>
                                                </Box>
                                                <Box>
                                                    <Typography variant="subtitle2" color="text.secondary">Subscription Status</Typography>
                                                    <Typography variant="body1">
                                                        {user.owen.subscriptionState || 'No active subscription'}
                                                    </Typography>
                                                </Box>
                                            </Stack>
                                        </Grid>
